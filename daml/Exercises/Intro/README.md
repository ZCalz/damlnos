...
Welcome to Damlnos! These two exercises get you up and running.
...
`Daml.Script` is DAML's built-in testing and simulation framework. A `Script` lets you simulate ledger operations — allocating parties, creating contracts, exercising choices — without needing a running ledger. All exercises in Damlnos use `Daml.Script`.
